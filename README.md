...
El proyecto implementa un pipeline bioinformático completo para el análisis de expresión génica (RNA-Seq) en cáncer de mama. Se ha realizado una evaluación comparativa de modelos de Machine Learning (específicamente Random Forest y SVM con kernel radial) para clasificar el grado histológico tumoral, identificando los biomarcadores génicos con mayor capacidad predictiva y relevancia clínica.
